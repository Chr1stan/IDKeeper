...
public class databaseHelper2 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String table = "CREATE TABLE "+TABLE_NAME+"("+COL0+" integer primary key autoincrement, "+COL1+" text, "+COL2+" text, "+COL3+" text, "+COL4+" text)";
        db.execSQL(table);
    }
    ...
    public boolean addID(String idType, String idCode, String nac, String expDate){
    ...
    public boolean updateID(String id, String idType, String idCode, String nac, String expDate){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COL0, id);
        cv.put(COL1, idType);
